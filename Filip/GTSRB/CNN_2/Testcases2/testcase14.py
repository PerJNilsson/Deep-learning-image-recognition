...
# C^2(5) P C^2(3) P
# Dropout on layer: Conv layers
# Batch normalisation: Every layer

def cnn(x_train, y_train, x_test, y_test, batch_size, epochs, num_classes, input_shape, drop_out_rate, learn_rate, result_file):
